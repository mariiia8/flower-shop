...
KNOWLEDGE_BASE = {
    ...
    "как сохранить букет дольше": "Обновите срез стеблей под водой, добавьте сахар или специальную подкормку в вазу, меняйте воду каждый день 💐",
...
def ask_flower_ai(user_message):
    ...
    # Приветствия и несерьёзные вопросы
